...
{{- if and .Values.nats.serviceAccount.create .Values.global.features.rbac.enabled -}}
...
{{- if and .Values.nats.jetStream.serviceAccount.create .Values.global.features.rbac.enabled -}}
