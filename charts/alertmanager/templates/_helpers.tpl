...
{{ define "alertmanager.internalauthurl" -}}
{{- if .Values.global.enableHoustonInternalAuthorization  }}
nginx.ingress.kubernetes.io/auth-url: http://{{ .Release.Name }}-alertmanager.{{ .Release.Namespace }}.svc.cluster.local:8871/v1/authorization
{{- else }}
