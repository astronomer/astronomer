...
# Vendor components
VENDOR_COMPONENTS := cadvisor curator elasticsearch elasticsearch-exporter fluentd grafana kibana kube-state nginx pgbouncer pgbouncer-exporter prometheus redis registry statsd-exporter
