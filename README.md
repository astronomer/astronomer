...
When doing chart development, you only need python >=3.11 and some python packages. The test environment for unit testing will be installed into `venv` when you run `make test-unit`, or you can setup the venv by running `make venv`.
