...
@cache
def get_schema_k8s(api_version, kind, kube_version="1.22.0"):
...
@cache
def create_validator(api_version, kind, kube_version="1.22.0"):
...
def validate_k8s_object(instance, kube_version="1.22.0"):
