...
class TestHoustonHookJob:
    ...
    def test_au_strategy_job_defaults(self, kube_version):
        ...
        docs = render_chart(kube_version=kube_version, values={},
        ...
        assert docs[0]['metadata']['name'] \
            == 'release-name-update-resource-strategy'
    ...
    def test_upgrade_deployments_job_defaults(self, kube_version):
        ...
        assert c_by_name['post-upgrade-job']['args'] == ['yarn',
                'upgrade-deployments', '--', '--canary=false']
    ...
    def test_db_migration_job_defaults(self, kube_version):
        ...
        assert c_by_name['houston-db-migrations-job']['args'] == ['yarn'
                , 'migrate']
